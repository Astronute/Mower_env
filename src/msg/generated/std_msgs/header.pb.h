...
class Header PROTOBUF_FINAL :
 ...
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&::descriptor_table_std_5fmsgs_2fheader_2eproto);
    return ::descriptor_table_std_5fmsgs_2fheader_2eproto.file_level_metadata[kIndexInFileMessages];
  }
...
inline std::string* Header::unsafe_arena_release_frame_id() {
  // @@protoc_insertion_point(field_unsafe_arena_release:std_msgs.Header.frame_id)
...
inline void Header::unsafe_arena_set_allocated_frame_id(
  ...
  frame_id_.UnsafeArenaSetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      frame_id, GetArena());
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:std_msgs.Header.frame_id)
}
