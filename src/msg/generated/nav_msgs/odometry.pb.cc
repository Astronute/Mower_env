...
// source: nav_msgs/odometry.proto
...
static void InitDefaultsscc_info_Odometry_nav_5fmsgs_2fodometry_2eproto() {
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<3> scc_info_Odometry_nav_5fmsgs_2fodometry_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 3, 0, InitDefaultsscc_info_Odometry_nav_5fmsgs_2fodometry_2eproto}, {
...
static ::PROTOBUF_NAMESPACE_ID::Metadata file_level_metadata_nav_5fmsgs_2fodometry_2eproto[1];
static constexpr ::PROTOBUF_NAMESPACE_ID::EnumDescriptor const** file_level_enum_descriptors_nav_5fmsgs_2fodometry_2eproto = nullptr;
static constexpr ::PROTOBUF_NAMESPACE_ID::ServiceDescriptor const** file_level_service_descriptors_nav_5fmsgs_2fodometry_2eproto = nullptr;

const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_nav_5fmsgs_2fodometry_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
...
const char descriptor_table_protodef_nav_5fmsgs_2fodometry_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\027nav_msgs/odometry.proto\022\010nav_msgs\032\025std"
  "_msgs/header.proto\032\030geometry_msgs/pose.p"
  "roto\032\031geometry_msgs/twist.proto\"\250\001\n\010Odom"
  "etry\022 \n\006header\030\001 \001(\0132\020.std_msgs.Header\022\026"
  "\n\016child_frame_id\030\002 \001(\t\022/\n\004pose\030\003 \001(\0132!.g"
  "eometry_msgs.PoseWithCovariance\0221\n\005twist"
  "\030\004 \001(\0132\".geometry_msgs.TwistWithCovarian"
  "ceb\006proto3"
  ;
static const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable*const descriptor_table_nav_5fmsgs_2fodometry_2eproto_deps[3] = {
  &::descriptor_table_geometry_5fmsgs_2fpose_2eproto,
  &::descriptor_table_geometry_5fmsgs_2ftwist_2eproto,
  &::descriptor_table_std_5fmsgs_2fheader_2eproto,
};
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase*const descriptor_table_nav_5fmsgs_2fodometry_2eproto_sccs[1] = {
  &scc_info_Odometry_nav_5fmsgs_2fodometry_2eproto.base,
};
static ::PROTOBUF_NAMESPACE_ID::internal::once_flag descriptor_table_nav_5fmsgs_2fodometry_2eproto_once;
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_nav_5fmsgs_2fodometry_2eproto = {
  false, false, descriptor_table_protodef_nav_5fmsgs_2fodometry_2eproto, "nav_msgs/odometry.proto", 290,
  &descriptor_table_nav_5fmsgs_2fodometry_2eproto_once, descriptor_table_nav_5fmsgs_2fodometry_2eproto_sccs, descriptor_table_nav_5fmsgs_2fodometry_2eproto_deps, 1, 3,
  schemas, file_default_instances, TableStruct_nav_5fmsgs_2fodometry_2eproto::offsets,
  file_level_metadata_nav_5fmsgs_2fodometry_2eproto, 1, file_level_enum_descriptors_nav_5fmsgs_2fodometry_2eproto, file_level_service_descriptors_nav_5fmsgs_2fodometry_2eproto,
};

// Force running AddDescriptors() at dynamic initialization time.
static bool dynamic_init_dummy_nav_5fmsgs_2fodometry_2eproto = (static_cast<void>(::PROTOBUF_NAMESPACE_ID::internal::AddDescriptors(&descriptor_table_nav_5fmsgs_2fodometry_2eproto)), true);
namespace nav_msgs {
...
Odometry::Odometry(::PROTOBUF_NAMESPACE_ID::Arena* arena)
  ...
  // @@protoc_insertion_point(arena_constructor:nav_msgs.Odometry)
}
Odometry::Odometry(const Odometry& from)
  ...
  if (!from._internal_child_frame_id().empty()) {
    child_frame_id_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), from._internal_child_frame_id(),
      GetArena());
  }
...
void Odometry::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_Odometry_nav_5fmsgs_2fodometry_2eproto.base);
  child_frame_id_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
...
template<> PROTOBUF_NOINLINE ::nav_msgs::Odometry* Arena::CreateMaybeMessage< ::nav_msgs::Odometry >(Arena* arena) {
  return Arena::CreateMessageInternal< ::nav_msgs::Odometry >(arena);
}
